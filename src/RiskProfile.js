      ...
      <div className="row">
        <div className="col-md-6">
          <div className="form-group">
            ...
            <select
              ...
              value={detailObject.schemeCode} disabled={isPreview ? true : false}
        ...
        <div className="col-md-6">
          <div className="form-group">
            ...
            <select
              name="" disabled={isPreview ? true : false}
              id=""
              className="form-control custom-select"
              style={{ backgroundPositionX: "500px" }}
              value={detailObject.assetAllocation}
              onChange={(e) =>
        ...
        <div className="col-md-6">
          <div className="form-group">
            ...
            <select
              ...
              className="form-control custom-select"
              style={{ backgroundPositionX: "500px" }}
              value={detailObject.mediumvolatilityBalance}
              onChange={(e) =>
        ...
        <div className="col-md-6">
          <div className="form-group">
            ...
            <select disabled={isPreview ? true : false}
              name=""
              id=""
              className="form-control custom-select"
              style={{ backgroundPositionX: "500px" }}
              value={detailObject.lowvolatilityBalance}
              onChange={(e) =>
        ...
        <div className="col-md-6">
          <div className="form-group">
            ...
            <select disabled={isPreview ? true : false}
              ...
              className="form-control custom-select"
              style={{ backgroundPositionX: "500px" }}
              value={detailObject.lowervolatilityBalance}
              onChange={(e) =>
            ...
            >
              ...
              <option value='Js Pention Saving Fund Equity Sub Fund : 0 '>Js Pention Saving Fund Equity Sub Fund : 0 </option>
